...
hide_title: true
slug: "7128621-sign-in-with-apple-for-web"
hide_table_of_contents: true
---

To enable Sign in with Apple on Web, you would have to follow some additional steps in the Apple Developer account and Firebase.

These steps are required for Apple to identify the website and provide access to the "Sign in with Apple on Web" functionality.
